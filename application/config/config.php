...
$config['wp-login']=true;
// wp path to wp-blog-header.php
$config['wp-path']='../baksiv/wp-blog-header.php';
...
$config['activation_subject'] = "Bakanlık Sınav Hesap Aktivasyonu";
// activation email message
$config['activation_message'] = "Merhaba, \r\n Kayıt olduğunuz için teşekkür ederiz, hesabını aktifleştirmek için lütfen .\r\n <a href='[buraya]'>[verilink]</a> tıklayınız \r\n veya \r\n bu linki explorera kopyalayabilirsiniz. \r\n [verilink] \r\n \r\n Teşekkürler";


// password reset email subject
$config['password_subject'] = "Şifre Değiştirildi";
// password reset email message
$config['password_message'] = "Merhaba, \r\n Yeni Şifreniz: [new_password] \r\n Teşekkürler";
...
// email send from
$config['fromemail']="yonetici@bakanliksinav.com";
// from name
$config['fromname']="Administrator - Bakanlık Sınav Portalı";
...
$config['base_currency_sufix']="TL";

$config['payment_gateways']=array('1','kredikarti','diger');
$config['default_gateway']=1;
...
$config['paypal_currency_prefix']="â‚º";
$config['paypal_currency_sufix']="TL";
...
$config['checkout_currency_prefix']="â‚º";
$config['checkout_currency_sufix']="TL";
...
// payu salt
$config['payu_salt']="";
$config['payumoney_currency_prefix']="â‚º";
$config['payumoney_currency_sufix']="TL";
