...
class Qbank extends CI_Controller {
	...
	public function remove_question($qid){
		...
		public function soru_onay($qid,$new_status){
		    ...
		    if($this->qbank_model->soru_onay($qid,$new_status)){
		        $this->session->set_flashdata('message', "<div class='alert alert-success'>İşlem Başarıyla Gerçekleştirildi</div>");
		    }else{
		        $this->session->set_flashdata('message', "<div class='alert alert-danger'>Hata Oluştu</div>");
	...
	public function new_question_1($nop='4',$categoryId=0)
	{
			...
			if($this->input->post('question')){
				if($this->qbank_model->insert_question_1()){
				    $data['sel_cat_id']=$this->input->post('cid');
                    $this->session->set_flashdata('message', "<div class='alert alert-success'>".$this->lang->line('data_added_successfully')." </div>");
				}else{
				    $this->session->set_flashdata('message', "<div class='alert alert-danger'>".$this->lang->line('error_to_add_data')." </div>");
				}
				redirect('qbank/pre_new_question/'.$nop."/".$this->input->post('cid'));
			}			
