...
<input type="text" id="comment_send" name="class_cont" placeholder="Enter Tuşu Gönderir" onKeyup="javascript: if (event.keyCode=='13') comment('<?php echo $class_id;?>');" >
</div>
