 ...
 <div class="login-panel panel panel-default">
		...
		?>
				...
				<div class="form-group">	 
					...
					<input type="text" name="start_date"  value="<?php echo date('d.m.Y H:i:s',$quiz['start_date']);?>" class="form-control" placeholder="<?php echo $this->lang->line('start_date');?>"   required >
			</div>
				<div class="form-group">	 
					<label for="inputEmail"  ><?php echo $this->lang->line('end_date');?></label> 
					<input type="text" name="end_date"  value="<?php echo date('d.m.Y H:i:s',$quiz['end_date']);?>" class="form-control" placeholder="<?php echo $this->lang->line('end_date');?>"   required >
			</div>
				<div class="form-group">	 
			...
			<div class="form-group">	 
					...
					<option value="Default" <?php if($quiz['quiz_template']=="Default"){ echo 'selected';} ?> >Normal</option>
					<option value="Advance"  <?php if($quiz['quiz_template']=="Advance"){ echo 'selected';} ?> >Özel</option>
