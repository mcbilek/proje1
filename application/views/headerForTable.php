<html lang="en">
  ...
  <title><?php echo $title;?></title>
	...
	<!-- custom javascript -->
	<script src="<?php echo base_url('js/basic.js?v=1');?>"></script>
		
	<!-- bootstrap js -->
    <script src="<?php echo base_url('bootstrap/js/bootstrap.min.js');?>"></script>
    <script src="<?php echo base_url('bootstrap/js/bootstrap-formhelpers-phone.js');?>"></script>
    <script src="<?php echo base_url('bootstrap/js/bootstrap-select.js');?>"></script>

    <!-- Latest compiled and minified JavaScript -->
	<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.12.4/js/bootstrap-select.min.js"></script>

    <!-- (Optional) sonradan ekledim -->
	...
	<script src="//cdnjs.cloudflare.com/ajax/libs/bootstrap-table/1.12.1/locale/bootstrap-table-tr-TR.min.js"></script>
	 <!-- bootstrap-table dosyaları bitiş -->
	<script src="<?php echo base_url('bootstrap/js/bootstrap-table-export.js');?>"></script>
	...
	?>
        ...
        <div class="container-fluid">
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="https://www.bakanliksinav.com/sinav"><?php echo $this->lang->line('savsoft_quiz');?></a>
          </div>
