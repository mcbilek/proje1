...
<div class="class_text_board">
	<div class="class_heading">
		Notlar <img title="Attach file" style="margin-left:20px;cursor:pointer;" src="<?php echo base_url();?>images/attachment.png" onClick="show_drop();">
 <div id="page_res" ></div>
	</div>
...
<input type="text" id="comment_send" name="class_cont" placeholder="Yorumunuzu girin" onKeyup="javascript: if (event.keyCode=='13') comment('<?php echo $class_id;?>');" >
</div>

<div style="clear:both;"></div>
Not: Enter tuşu gönderir
<br><br>
<a href="<?php echo site_url('liveclass/close_class/'.$class_id);?>"  class="btn btn-danger btn-xs">Bu sınıfı kapat</a>
