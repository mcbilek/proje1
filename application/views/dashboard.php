...
$months=array('Ock','Şbt','Mar','Nis','May','Haz','Tem','Ağu','Eyl','Eki','Kas','Ara');
?>
<div class="revenuew">
...
<?php 
echo "Page rendered in <strong>{elapsed_time}</strong> seconds. You may improve it by hosting on recommended hosting. ";
?>
</div>
