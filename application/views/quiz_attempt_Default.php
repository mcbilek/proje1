...
?>
 ...
 <div id="q<?php echo $qk;?>" class="question_div">
		...
		<div class="op"><div class="radio"><label><input type="radio" name="answer[<?php echo $qk;?>][]"  id="answer_value<?php echo $qk.'-'.$i;?>" value="<?php echo $option['oid'];?>"   <?php if(in_array($option['oid'],$save_ans)){ echo 'checked'; } ?>  ><?php echo $abc[$i];?>)  <?php echo $option['q_option'];?> </label></div></div>
